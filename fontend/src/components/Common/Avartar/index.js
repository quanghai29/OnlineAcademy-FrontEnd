...
export default function Overview(props) {
  return (
    <div className="container center-align">
      ...
      {!props.imgSrc && props.nickName && <div className={`container ${classes.avartar} circle blue-grey white-text`}><h5 className="center-align" style={{margin: "1px 0"}}>{props.nickName[0]}</h5></div>}
