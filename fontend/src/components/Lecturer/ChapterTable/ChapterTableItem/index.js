...
import { setSelectedChapter } from '../../../../redux/actions/chaptersOfCourse';
...
const ChapterTableItem = ({chapter}) => {
  ...
  const initModal = () => {
    var elems = document.getElementById('edit-chapter-title-modal');
    M.Modal.init(elems, {});
    M.updateTextFields();
  }
    ...
    <div className="card">
      ...
      <div className={`card-content ${classes.chapterTableItem}`}>
        ...
        <div className={classes.titleRight}>
            ...
            <button><span className="material-icons">video_call</span> Thêm video</button>
            <button><span className="material-icons">delete_forever</span> Xóa chương</button>
        </div>
      </div>
